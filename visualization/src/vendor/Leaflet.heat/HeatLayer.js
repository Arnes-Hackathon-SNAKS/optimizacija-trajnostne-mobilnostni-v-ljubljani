...
export const HeatLayer = (Layer ? Layer : Class).extend({
    ...
    _initCanvas: function () {
        var canvas = this._canvas = DomUtil.create("canvas", "leaflet-heatmap-layer leaflet-layer");
...
export const heatLayer = function (latlngs, options) {
